(function() {
    ...
    **/
    ...
    ShootingStar = function(id) {
      ...
      this.capa =  "body";//($(id).lenght > 0) ? "body" : id;
    ...
    ShootingStar.prototype.addBeamPart = function(x, y) {
      ...
      $("#star" + name).append("<div id='haz" + this.n + "' class='haz' style='z-index:-99;position:absolute; color:#FF0; width:10px; height:10px; font-weight:bold; font-size:" + this.options.starSize + "px'>·</div>");
